...
# ============= Load Football ==============
gml_path = os.path.join("/home/toto/Eska/Data", "football.gml")
...
# ============================================================
def tune_CFinder(G):
    k_values = range(3, 20)  # biasanya 3-6 cukup
    best_mod = -1
    best_k = None
...
def tune_Hybrid(G):
    ...
    lower_thr_values = [0.5] # Ditambah 0.7 untuk eksplorasi
    upper_thr_values = [0.3]
